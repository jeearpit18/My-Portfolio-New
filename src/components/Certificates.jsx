...
const CertificateCard = ({ cert, aosDelay }) => {
  const content = (
    <div
      ...
      className={`bg-black/20 backdrop-blur-sm rounded-2xl p-5 border border-white/10 hover:border-white/25 hover:scale-105 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] transition-all duration-500 group h-full ${cert.url ? 'cursor-pointer' : 'cursor-default'}`}
    >
...
const Certificates = () => {
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        <div data-aos="fade-up" className="mb-12 md:mb-16 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Programs, credentials, and recognitions that support my engineering and leadership work.
          </p>
        </div>
      ...
      <div
        className="absolute bottom-20 right-8 md:right-24 text-black opacity-20 animate-pulse"
